        ...
        stage('Push to Docker Hub') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerhub_credentials', passwordVariable: 'DOCKER_HUB_PASSWORD', usernameVariable: 'DOCKER_HUB_USERNAME')]) {
                    ...
                    sh "/Applications/Docker.app/Contents/Resources/bin/docker tag evalspringse:latest bounafode/evalspringse:v$BUILD_NUMBER"
                    sh "/Applications/Docker.app/Contents/Resources/bin/docker push bounafode/evalspringse:v$BUILD_NUMBER"
               }
            }
       }
    }
